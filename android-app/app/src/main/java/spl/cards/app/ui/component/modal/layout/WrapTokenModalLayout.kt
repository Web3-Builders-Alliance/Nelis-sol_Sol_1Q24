...
fun WrapTokenModal(
    ...
    if (walletItems.isNotEmpty()) {
        val viewModel: WrapTokenViewModel = koinViewModel()
        ...
        WrapTokenModalLayout(
            ...
            onClickWrapToken = { walletItem: WalletItem, amount: Double, pinCode: String ->
...
fun WrapTokenModalLayout(
    ...
    onClickWrapToken: (WalletItem, Double, String) -> Unit
) {
    ...
    Box(
        ...
        Column {
            ...
            Text(
                text = stringResource(id = R.string.modal_wrap_token_message),
        ...
        if (sendButtonEnabled) {
            GradientButton(
                ...
                text = stringResource(id = R.string.button_confirm_wrapping),
                loading = sendTransactionLoading,
                onClick = {
                    onClickWrapToken.invoke(
