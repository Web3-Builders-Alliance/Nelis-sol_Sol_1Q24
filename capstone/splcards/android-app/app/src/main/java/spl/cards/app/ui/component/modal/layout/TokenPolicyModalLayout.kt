...
fun TokenPolicyModal(
    ...
    if (walletItems.isNotEmpty()) {
        val viewModel: TokenPolicyViewModel = koinViewModel()
        ...
        TokenPolicyModalLayout(
            ...
            onClickSendTransaction = { walletItem: WalletItem, amount: Double, pinCode: String ->
                //SentryHelper.sendUserInteractionBreadcrumb(component = "Send Transaction Button")
                viewModel.updateTokenPolicy(
...
fun TokenPolicyModalLayout(
    ...
    onClickSendTransaction: (WalletItem, Double, String) -> Unit
) {
    ...
    Box(
        ...
        if (sendButtonEnabled) {
            GradientButton(
                ...
                text = stringResource(id = R.string.button_update_policy),
